...
export function identifyGroup(conditionCode) {
  ...
  if (tempoLimpo.includes(conditionCode)) {
    ...
    return 6;
  } else if (outros.includes(conditionCode)) {
    return 7;
  } else {
    return 8; //Serviço não disponível (atribuir um número e colocar a cor branca para esse)
  }
}
